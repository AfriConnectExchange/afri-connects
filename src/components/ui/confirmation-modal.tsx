...
import { AlertTriangle, Trash2, LogOut, X, AlertCircle, CheckCircle, Info, HelpCircle } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
      ...
      <AlertDialogContent className="max-w-md">
        ...
        {(details || consequences) && (
          <div className="space-y-4">
            ...
            {consequences && (
              <div>
                <h4 className="font-medium text-sm mb-2 text-amber-600">Consequences:</h4>
                <ul className="space-y-1">
  ...
  return (
    <ConfirmationModal
      ...
      consequences={[
        ...
        'You will need to recreate this item if needed later'
      ]}
      isLoading={isLoading}
  ...
  return (
    <ConfirmationModal
      ...
      consequences={[
        ...
        'All associated files and documents will be deleted'
      ]}
      isLoading={isLoading}
